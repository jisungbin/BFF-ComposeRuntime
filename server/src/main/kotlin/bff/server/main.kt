...
import bff.ui.screens
import bff.ui.widgets
...
fun main() {
  val screenResponse = runBlocking {
    screens {
      RootScreen(
        Attributes
  ...
  val widgetResponse = runBlocking {
    widgets {
      SearchHospitalAWidget(
        Attributes
          .size(SizeArea.SIZE_AREA_WIDTH, 123f)
  ...
  println(responseAdaptor.toJson(screenResponse))
  repeat(10) { println("=".repeat(100)) }
  println(responseAdaptor.toJson(widgetResponse))
}
